...
export const Sections1to8 = () => {
  return (
    <>
      ...
      <Section title="2. COMMANDES - DEVIS">
        <p className="mb-4">
      ...
      <Section title="4. CONDITIONS DE REGLEMENT">
        <p className="mb-4">
      ...
      <Section title="6. RESERVE DE PROPRIETE">
        <p className="mb-4">
      ...
      <Section title="7. CLAUSE RESOLUTOIRE">
        <p className="mb-4">
