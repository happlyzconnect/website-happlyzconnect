...
export const Hero = () => {
  return (
    <div className="relative min-h-[calc(100vh-72px)] flex items-center bg-gradient-to-br from-business-primary to-business-secondary text-white overflow-hidden mt-[72px]">
      <div 
