  ...
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-business-primary to-business-secondary text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] bg-business-primary/40 p-4 rounded-lg backdrop-blur-sm inline-block">
